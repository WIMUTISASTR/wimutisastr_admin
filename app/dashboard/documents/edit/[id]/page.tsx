            ...
            <div className="min-w-0">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-slate-600">ដោយ {book.author}</p>
                </div>
              </div>
        ...
        {isFilePreviewOpen && (
          <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 border-b border-slate-200">
              <div className="min-w-0">
                <div className="text-sm font-semibold text-slate-900 truncate">មើលព្រលត់ឯកសារ</div>
            ...
            <div className="flex flex-col h-[70vh] bg-slate-50">
              ...
              <div className="p-3 text-sm text-slate-600 border-t border-slate-200 bg-white">
                ប្រសិនបើការមើលព្រលត់មិនបង្ហាញ សូមប្រើ 'អេក្រង់ពេញ' ឬ 'ទាញយក' ខាងលើ។
              </div>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 md:p-6 shadow-sm">
              ...
              <p className="text-sm text-slate-600 mt-1">ធ្វើបច្ចុប្បន្នភាពព័ត៌មានឯកសារ</p>
                ...
                {selectedMainCategoryId && availableSubcategories.length > 0 && (
                  <div>
                    ...
                    <select
                      ...
                      disabled={isLoading}
                    >
                      <option value="">គ្មាន (ប្រើប្រភេទ)</option>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      ស្រេចចិត្ត: ជ្រើសរើសប្រភេទរងសម្រាប់ការរៀបចំជាក់លាក់
                    </p>
                  </div>
                )}
              ...
              <div className="mt-5 space-y-5">
                ...
                <div className="rounded-xl border border-slate-200 p-4 bg-slate-50">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-sm font-semibold text-slate-900">ឯកសារ</p>
                      ...
                      {bookFile && (
                        <p className="text-xs text-blue-700 mt-2">
                          ឯកសារថ្មី: <span className="font-semibold">{bookFile.name}</span> ({formatFileSize(bookFile.size)})
                        </p>
                      )}
                    </div>
                  ...
                  <p className="text-xs text-slate-500 mt-3">
                    គាំទ្រ: PDF, DOC, DOCX, EPUB, MOBI, TXT. អតិបរមា 500MB
                  </p>
                </div>
